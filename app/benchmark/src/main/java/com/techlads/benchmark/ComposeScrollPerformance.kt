...
class ComposeScrollPerformanceBenchmark {
    ...
    fun composeScrollPerformanc() = benchmarkRule.measureRepeated(
        ...
        setupBlock = {
            ...
            device.wait(Until.hasObject(By.text("Gallery")), 10_000)
    ...
    private fun MacrobenchmarkScope.scrollThroughHomeSections() {
        ...
        device.wait(Until.hasObject(By.res("images_list")), 10_000)

        val recycler = device.findObject(By.res("images_list"))
